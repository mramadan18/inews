const LoadingPage = () => {
  return (
    <div className="loader-box-page position-fixed top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center align-items-center z-3 bg-white text-center">
      <svg
